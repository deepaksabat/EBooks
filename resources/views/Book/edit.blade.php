        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($book, array('route' => array('books.update', $book->id), 'method' => 'PUT', 'files'=>true,'class'=>'form-horizontal')) !!}

                    <div class="form-group{{ $errors->has('book_fl') ? ' has-error' : '' }}">
                        {{ Form::label('Book',null,array('class' => ' control-label col-md-2')) }}
                        <div class="col-md-10"> 
                         {{ Form::file('book_fl', null, array('class' => 'form-control','accept'=>'application/pdf,chm,djvu,epub')) }} @if ($errors->has('book_fl'))
                    ...
                    <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            {{ Form::select('category_id',$category,null, array('class' => 'form-control test1','placeholder'=>'select a category')) }}
                    ...
                    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-10"> 
                         ...
                         {{ Html::image('book'.'/'.$book->id.'/'.$book->image,'a picture',array( 'width' => 70, 'height' => 70 )) }}
                          @if ($errors->has('image'))
                        <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('book_size') ? ' has-error' : '' }}">
                        {{ Form::label('Book Size',null,array('class' => ' control-label col-md-2')) }}
                        <div class="col-md-10"> 
